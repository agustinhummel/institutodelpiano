    ...
    <nav className='z-40 shadow-md w-full  fixed + top-0 left-0 font-serif'>
      <div className='md:flex items-center justify-between bg-main-color py-4 md:px-10 px-7'>
          ...
          <ion-icon name={open ? 'close': 'menu' }></ion-icon>
            ...
            <ul className={`md:flex md:items-center md:pb-0 h-screen   absolute md:static bg-sky-300 md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-20 opacity-100':'top-[-490px]'} md:opacity-100 opacity-0`}>
